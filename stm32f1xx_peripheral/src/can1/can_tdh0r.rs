...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn data4(&mut self) -> Data4W<CanTdh0rSpec> {
        Data4W::new(self, 0)
    }
    #[doc = "Bits 8:15 - DATA5"]
    #[inline(always)]
    #[must_use]
    pub fn data5(&mut self) -> Data5W<CanTdh0rSpec> {
        Data5W::new(self, 8)
    }
    #[doc = "Bits 16:23 - DATA6"]
    #[inline(always)]
    #[must_use]
    pub fn data6(&mut self) -> Data6W<CanTdh0rSpec> {
        Data6W::new(self, 16)
    }
    #[doc = "Bits 24:31 - DATA7"]
    #[inline(always)]
    #[must_use]
    pub fn data7(&mut self) -> Data7W<CanTdh0rSpec> {
        Data7W::new(self, 24)
    }
}
