...
pub type R = crate::R<CanRf1rSpec>;
#[doc = "Register `CAN_RF1R` writer"]
pub type W = crate::W<CanRf1rSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn full1(&mut self) -> Full1W<CanRf1rSpec> {
        Full1W::new(self, 3)
    }
    #[doc = "Bit 4 - FOVR1"]
    #[inline(always)]
    #[must_use]
    pub fn fovr1(&mut self) -> Fovr1W<CanRf1rSpec> {
        Fovr1W::new(self, 4)
    }
    #[doc = "Bit 5 - RFOM1"]
    #[inline(always)]
    #[must_use]
    pub fn rfom1(&mut self) -> Rfom1W<CanRf1rSpec> {
        Rfom1W::new(self, 5)
    }
}
#[doc = "CAN_RF1R\n\nYou can [`read`](crate::Reg::read) this register and get [`can_rf1r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`can_rf1r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CanRf1rSpec;
impl crate::RegisterSpec for CanRf1rSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`can_rf1r::R`](R) reader structure"]
impl crate::Readable for CanRf1rSpec {}
#[doc = "`write(|w| ..)` method takes [`can_rf1r::W`](W) writer structure"]
impl crate::Writable for CanRf1rSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CAN_RF1R to value 0"]
impl crate::Resettable for CanRf1rSpec {
