...
pub type R = crate::R<F3r2Spec>;
#[doc = "Register `F3R2` writer"]
pub type W = crate::W<F3r2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fb0(&mut self) -> Fb0W<F3r2Spec> {
        Fb0W::new(self, 0)
    }
    #[doc = "Bit 1 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb1(&mut self) -> Fb1W<F3r2Spec> {
        Fb1W::new(self, 1)
    }
    #[doc = "Bit 2 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb2(&mut self) -> Fb2W<F3r2Spec> {
        Fb2W::new(self, 2)
    }
    #[doc = "Bit 3 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb3(&mut self) -> Fb3W<F3r2Spec> {
        Fb3W::new(self, 3)
    }
    #[doc = "Bit 4 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb4(&mut self) -> Fb4W<F3r2Spec> {
        Fb4W::new(self, 4)
    }
    #[doc = "Bit 5 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb5(&mut self) -> Fb5W<F3r2Spec> {
        Fb5W::new(self, 5)
    }
    #[doc = "Bit 6 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb6(&mut self) -> Fb6W<F3r2Spec> {
        Fb6W::new(self, 6)
    }
    #[doc = "Bit 7 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb7(&mut self) -> Fb7W<F3r2Spec> {
        Fb7W::new(self, 7)
    }
    #[doc = "Bit 8 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb8(&mut self) -> Fb8W<F3r2Spec> {
        Fb8W::new(self, 8)
    }
    #[doc = "Bit 9 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb9(&mut self) -> Fb9W<F3r2Spec> {
        Fb9W::new(self, 9)
    }
    #[doc = "Bit 10 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb10(&mut self) -> Fb10W<F3r2Spec> {
        Fb10W::new(self, 10)
    }
    #[doc = "Bit 11 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb11(&mut self) -> Fb11W<F3r2Spec> {
        Fb11W::new(self, 11)
    }
    #[doc = "Bit 12 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb12(&mut self) -> Fb12W<F3r2Spec> {
        Fb12W::new(self, 12)
    }
    #[doc = "Bit 13 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb13(&mut self) -> Fb13W<F3r2Spec> {
        Fb13W::new(self, 13)
    }
    #[doc = "Bit 14 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb14(&mut self) -> Fb14W<F3r2Spec> {
        Fb14W::new(self, 14)
    }
    #[doc = "Bit 15 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb15(&mut self) -> Fb15W<F3r2Spec> {
        Fb15W::new(self, 15)
    }
    #[doc = "Bit 16 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb16(&mut self) -> Fb16W<F3r2Spec> {
        Fb16W::new(self, 16)
    }
    #[doc = "Bit 17 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb17(&mut self) -> Fb17W<F3r2Spec> {
        Fb17W::new(self, 17)
    }
    #[doc = "Bit 18 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb18(&mut self) -> Fb18W<F3r2Spec> {
        Fb18W::new(self, 18)
    }
    #[doc = "Bit 19 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb19(&mut self) -> Fb19W<F3r2Spec> {
        Fb19W::new(self, 19)
    }
    #[doc = "Bit 20 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb20(&mut self) -> Fb20W<F3r2Spec> {
        Fb20W::new(self, 20)
    }
    #[doc = "Bit 21 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb21(&mut self) -> Fb21W<F3r2Spec> {
        Fb21W::new(self, 21)
    }
    #[doc = "Bit 22 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb22(&mut self) -> Fb22W<F3r2Spec> {
        Fb22W::new(self, 22)
    }
    #[doc = "Bit 23 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb23(&mut self) -> Fb23W<F3r2Spec> {
        Fb23W::new(self, 23)
    }
    #[doc = "Bit 24 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb24(&mut self) -> Fb24W<F3r2Spec> {
        Fb24W::new(self, 24)
    }
    #[doc = "Bit 25 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb25(&mut self) -> Fb25W<F3r2Spec> {
        Fb25W::new(self, 25)
    }
    #[doc = "Bit 26 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb26(&mut self) -> Fb26W<F3r2Spec> {
        Fb26W::new(self, 26)
    }
    #[doc = "Bit 27 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb27(&mut self) -> Fb27W<F3r2Spec> {
        Fb27W::new(self, 27)
    }
    #[doc = "Bit 28 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb28(&mut self) -> Fb28W<F3r2Spec> {
        Fb28W::new(self, 28)
    }
    #[doc = "Bit 29 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb29(&mut self) -> Fb29W<F3r2Spec> {
        Fb29W::new(self, 29)
    }
    #[doc = "Bit 30 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb30(&mut self) -> Fb30W<F3r2Spec> {
        Fb30W::new(self, 30)
    }
    #[doc = "Bit 31 - Filter bits"]
    #[inline(always)]
    #[must_use]
    pub fn fb31(&mut self) -> Fb31W<F3r2Spec> {
        Fb31W::new(self, 31)
    }
}
#[doc = "Filter bank 3 register 2\n\nYou can [`read`](crate::Reg::read) this register and get [`f3r2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`f3r2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct F3r2Spec;
impl crate::RegisterSpec for F3r2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`f3r2::R`](R) reader structure"]
impl crate::Readable for F3r2Spec {}
#[doc = "`write(|w| ..)` method takes [`f3r2::W`](W) writer structure"]
impl crate::Writable for F3r2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets F3R2 to value 0"]
impl crate::Resettable for F3r2Spec {
