...
pub type R = crate::R<F11r1Spec>;
#[doc = "Register `F11R1` writer"]
pub type W = crate::W<F11r1Spec>;
...
#[doc = "Filter bank 11 register 1\n\nYou can [`read`](crate::Reg::read) this register and get [`f11r1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`f11r1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct F11r1Spec;
impl crate::RegisterSpec for F11r1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`f11r1::R`](R) reader structure"]
impl crate::Readable for F11r1Spec {}
#[doc = "`write(|w| ..)` method takes [`f11r1::W`](W) writer structure"]
impl crate::Writable for F11r1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets F11R1 to value 0"]
impl crate::Resettable for F11r1Spec {
