#[doc = "Register `CAN_TSR` reader"]
pub type R = crate::R<CanTsrSpec>;
#[doc = "Register `CAN_TSR` writer"]
pub type W = crate::W<CanTsrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rqcp0(&mut self) -> Rqcp0W<CanTsrSpec> {
        Rqcp0W::new(self, 0)
    }
    #[doc = "Bit 1 - TXOK0"]
    #[inline(always)]
    #[must_use]
    pub fn txok0(&mut self) -> Txok0W<CanTsrSpec> {
        Txok0W::new(self, 1)
    }
    #[doc = "Bit 2 - ALST0"]
    #[inline(always)]
    #[must_use]
    pub fn alst0(&mut self) -> Alst0W<CanTsrSpec> {
        Alst0W::new(self, 2)
    }
    #[doc = "Bit 3 - TERR0"]
    #[inline(always)]
    #[must_use]
    pub fn terr0(&mut self) -> Terr0W<CanTsrSpec> {
        Terr0W::new(self, 3)
    }
    #[doc = "Bit 7 - ABRQ0"]
    #[inline(always)]
    #[must_use]
    pub fn abrq0(&mut self) -> Abrq0W<CanTsrSpec> {
        Abrq0W::new(self, 7)
    }
    #[doc = "Bit 8 - RQCP1"]
    #[inline(always)]
    #[must_use]
    pub fn rqcp1(&mut self) -> Rqcp1W<CanTsrSpec> {
        Rqcp1W::new(self, 8)
    }
    #[doc = "Bit 9 - TXOK1"]
    #[inline(always)]
    #[must_use]
    pub fn txok1(&mut self) -> Txok1W<CanTsrSpec> {
        Txok1W::new(self, 9)
    }
    #[doc = "Bit 10 - ALST1"]
    #[inline(always)]
    #[must_use]
    pub fn alst1(&mut self) -> Alst1W<CanTsrSpec> {
        Alst1W::new(self, 10)
    }
    #[doc = "Bit 11 - TERR1"]
    #[inline(always)]
    #[must_use]
    pub fn terr1(&mut self) -> Terr1W<CanTsrSpec> {
        Terr1W::new(self, 11)
    }
    #[doc = "Bit 15 - ABRQ1"]
    #[inline(always)]
    #[must_use]
    pub fn abrq1(&mut self) -> Abrq1W<CanTsrSpec> {
        Abrq1W::new(self, 15)
    }
    #[doc = "Bit 16 - RQCP2"]
    #[inline(always)]
    #[must_use]
    pub fn rqcp2(&mut self) -> Rqcp2W<CanTsrSpec> {
        Rqcp2W::new(self, 16)
    }
    #[doc = "Bit 17 - TXOK2"]
    #[inline(always)]
    #[must_use]
    pub fn txok2(&mut self) -> Txok2W<CanTsrSpec> {
        Txok2W::new(self, 17)
    }
    #[doc = "Bit 18 - ALST2"]
    #[inline(always)]
    #[must_use]
    pub fn alst2(&mut self) -> Alst2W<CanTsrSpec> {
        Alst2W::new(self, 18)
    }
    #[doc = "Bit 19 - TERR2"]
    #[inline(always)]
    #[must_use]
    pub fn terr2(&mut self) -> Terr2W<CanTsrSpec> {
        Terr2W::new(self, 19)
    }
    #[doc = "Bit 23 - ABRQ2"]
    #[inline(always)]
    #[must_use]
    pub fn abrq2(&mut self) -> Abrq2W<CanTsrSpec> {
        Abrq2W::new(self, 23)
    }
}
#[doc = "CAN_TSR\n\nYou can [`read`](crate::Reg::read) this register and get [`can_tsr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`can_tsr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CanTsrSpec;
impl crate::RegisterSpec for CanTsrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`can_tsr::R`](R) reader structure"]
impl crate::Readable for CanTsrSpec {}
#[doc = "`write(|w| ..)` method takes [`can_tsr::W`](W) writer structure"]
impl crate::Writable for CanTsrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CAN_TSR to value 0"]
impl crate::Resettable for CanTsrSpec {
