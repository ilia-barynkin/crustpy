...
pub type R = crate::R<CanRdl1rSpec>;
...
#[doc = "CAN_RDL1R\n\nYou can [`read`](crate::Reg::read) this register and get [`can_rdl1r::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CanRdl1rSpec;
impl crate::RegisterSpec for CanRdl1rSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`can_rdl1r::R`](R) reader structure"]
impl crate::Readable for CanRdl1rSpec {}
#[doc = "`reset()` method sets CAN_RDL1R to value 0"]
impl crate::Resettable for CanRdl1rSpec {
