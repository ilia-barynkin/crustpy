#[doc = "Register `CAN_TI0R` reader"]
pub type R = crate::R<CanTi0rSpec>;
#[doc = "Register `CAN_TI0R` writer"]
pub type W = crate::W<CanTi0rSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn txrq(&mut self) -> TxrqW<CanTi0rSpec> {
        TxrqW::new(self, 0)
    }
    #[doc = "Bit 1 - RTR"]
    #[inline(always)]
    #[must_use]
    pub fn rtr(&mut self) -> RtrW<CanTi0rSpec> {
        RtrW::new(self, 1)
    }
    #[doc = "Bit 2 - IDE"]
    #[inline(always)]
    #[must_use]
    pub fn ide(&mut self) -> IdeW<CanTi0rSpec> {
        IdeW::new(self, 2)
    }
    #[doc = "Bits 3:20 - EXID"]
    #[inline(always)]
    #[must_use]
    pub fn exid(&mut self) -> ExidW<CanTi0rSpec> {
        ExidW::new(self, 3)
    }
    #[doc = "Bits 21:31 - STID"]
    #[inline(always)]
    #[must_use]
    pub fn stid(&mut self) -> StidW<CanTi0rSpec> {
        StidW::new(self, 21)
    }
}
#[doc = "CAN_TI0R\n\nYou can [`read`](crate::Reg::read) this register and get [`can_ti0r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`can_ti0r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CanTi0rSpec;
impl crate::RegisterSpec for CanTi0rSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`can_ti0r::R`](R) reader structure"]
impl crate::Readable for CanTi0rSpec {}
#[doc = "`write(|w| ..)` method takes [`can_ti0r::W`](W) writer structure"]
impl crate::Writable for CanTi0rSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CAN_TI0R to value 0"]
impl crate::Resettable for CanTi0rSpec {
